...
func TestGetAllConfiguration(t *testing.T) {
	...
	if err := configurationRepositoryTest.mock.ExpectationsWereMet(); err != nil {
		t.Errorf("TestGetAllConfiguration ExpectationsWereMet: %s", err.Error())
		t.Fail()
	}
}
...
func TestGetConfigurationCapacity(t *testing.T) {
	...
	if err := configurationRepositoryTest.mock.ExpectationsWereMet(); err != nil {
		t.Errorf("TestGetConfigurationCapacity ExpectationsWereMet: %s", err.Error())
		t.Fail()
	}
}
...
func TestGetConfigurationById(t *testing.T) {
	...
	if err := configurationRepositoryTest.mock.ExpectationsWereMet(); err != nil {
		t.Errorf("TestGetConfigurationById ExpectationsWereMet: %s", err.Error())
		t.Fail()
	}
}
